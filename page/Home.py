...
def main():
    ...
    if pages == "Peta":
        ...
        # st.warning("**PERINGATAN!!!** Setelah pengguna menekan tombol *Lakukan Clustering* untuk melakukan analisis ulang ataupun tombol *Simpan Hasil* untuk mengunduh hasil analisis, maka hasil analisis saat itu akan langsung terhapus.")
